...
//   return (
//     <>
//       <h1 className="text-3xl font-bold underline">ini font body</h1>
//       <h1 className="text-3xl font-poppins">ini font poppins</h1>
//       <h1 className="text-3xl font-bold text-primary">ini font body</h1>
//       <p>
//         ini font body juga. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Porro inventore possimus, iusto itaque repellat earum obcaecati, a tenetur, magni commodi perspiciatis doloribus laborum reiciendis tempora odio
//         praesentium? Ratione, quibusdam expedita?
//       </p>
//     </>
//   );
// }
